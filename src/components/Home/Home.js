            ...
            <div className='content'>
                ...
                <div className='stardetalles'>
                    <div className='cards-stardetalles'>
                        <div>
                            <h1>Movies</h1>
                            <p>Aquí encontraras información acerca de todas las peliculas de Star Wars.</p>
                            <Link to='/movies'>View More <FaArrowAltCircleRight /></Link>
                        </div>
                    </div>
                    <div className='cards-stardetalles'>
                        <div>
                    ...
                    <div className='cards-stardetalles'>
                        <div>
                            <h1>StarShips</h1>
                            <p>Aquí encontraras información acerca de todas las naves de Star Wars.</p>
